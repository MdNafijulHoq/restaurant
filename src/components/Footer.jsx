...
import logo1 from '../../src/assets/clock.png'
...
const Footer = () => {
    ...
    <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
            <a href="#">
                <p className='text-4xl text-white font-bold'>WE READY TO HAVE YOU THE BEST DINING EXPERIENCES</p>
            </a>

            <div className="flex flex-wrap justify-center mt-6 -mx-4 gap-10 lg:gap-20 xl:36">
               
                <div className='flex flex-col justify-center items-center space-y-2 text-sm text-white transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400'>
                ...
                <div className='flex flex-col justify-center items-center space-y-2 text-sm text-white transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400'>
                    <img className='w-6' src={logo3} alt="" />
                        <h4>BOOK A TABLE</h4>
                        <div>
                ...
                <div className='flex flex-col justify-center items-center space-y-2 text-sm text-white transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400'>
                    <img className='w-6' src={logo4} alt="" />
                        <h4>Our Address</h4>
                        <div>
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <p className="text-sm text-white lg:text-sky-800 dark:text-gray-300">© Copyright 2024. All Rights Reserved.</p>
